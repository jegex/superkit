...
class TaxonomyTagInput extends TagsInput
{
    ...
    protected function setUp(): void
    {
        ...
        $this->loadStateFromRelationshipsUsing(static function (TaxonomyTagInput $component, ?Model $record): void {
        ...
        $this->saveRelationshipsUsing(static function (TaxonomyTagInput $component, ?Model $record, array $state): void {
    ...
    protected function syncTagsWithAnyType(?Model $record, array $state): void
    {
        ...
        $tagClassName = config('tags.tag_model', Taxonomy::class);
    ...
    public function getSuggestions(): array
    {
        ...
        $tagClass = ($model && method_exists($model, 'getTagClassName'))
            ...
            : config('tags.tag_model', Taxonomy::class);
        $type = $this->getType();
